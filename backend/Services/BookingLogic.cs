...
{
    /// <summary>
    /// Two half-open intervals [start, end) overlap iff newStart &lt; existingEnd AND newEnd &gt; existingStart.
    /// Because the intervals are half-open, touching boundaries do NOT overlap:
    ...
    /// <summary>Force a DateTime to be treated as UTC (frontends send ISO-8601 UTC strings).</summary>
